...
- [GitHub](https://github.com/nteract/nteract) (👨‍💻 170 · 🔀 500 · 📥 1.2M · 📋 1.6K - 8% open · ⏱️ 20.04.2021):

	```
	git clone https://github.com/nteract/nteract
	```
- [PyPi](https://pypi.org/project/nteract_on_jupyter) (📥 4.6K / month):
	```
...
- [GitHub](https://github.com/ml-tooling/ml-workspace) (👨‍💻 9 · 🔀 230 · 📋 60 - 15% open · ⏱️ 15.01.2021):
...
- [GitHub](https://github.com/jtpio/jupyterlab-classic) (👨‍💻 3 · 🔀 8 · 📋 47 - 31% open · ⏱️ 20.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-classic) (📥 500 / month):
	```
...
- [GitHub](https://github.com/bokeh/bokeh) (👨‍💻 560 · 🔀 3.6K · 📦 33K · 📋 6.5K - 10% open · ⏱️ 20.04.2021):
...
<details><summary><b><a href="https://github.com/pandas-profiling/pandas-profiling">pandas-profiling</a></b> (🥇29 ·  ⭐ 7.2K) - Create HTML profiling reports from pandas DataFrame objects. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/ipympl) (📥 50K / month):
	...
	pip install ipympl
	```
- [NPM](https://www.npmjs.com/package/jupyter-matplotlib) (📥 91K / month):
	```
...
- [Conda](https://anaconda.org/conda-forge/ipyvolume) (📥 280K · ⏱️ 20.04.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/ipyvolume) (📥 5.2K / month):
	```
...
- [GitHub](https://github.com/mapbox/mapboxgl-jupyter) (👨‍💻 21 · 🔀 120 · 📦 95 · 📋 95 - 29% open · ⏱️ 19.04.2021):
...
- [GitHub](https://github.com/maartenbreddels/ipywebrtc) (👨‍💻 9 · 🔀 29 · 📦 240 · 📋 44 - 54% open · ⏱️ 29.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipywebrtc) (📥 19K / month):
	```
...
- [GitHub](https://github.com/QuantStack/ipycytoscape) (👨‍💻 26 · 🔀 39 · 📥 2 · 📦 28 · 📋 120 - 39% open · ⏱️ 22.04.2021):
...
- [GitHub](https://github.com/InsightSoftwareConsortium/itkwidgets) (👨‍💻 18 · 🔀 46 · 📥 50 · 📋 160 - 42% open · ⏱️ 18.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/itkwidgets) (📥 8.9K / month):
	```
...
<details><summary><b><a href="https://github.com/jpmorganchase/ipyregulartable">ipyregulartable</a></b> (🥉16 ·  ⭐ 30 · 📉) - High performance, editable, stylable datagrids in.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/QuantStack/ipytree) (👨‍💻 7 · 🔀 17 · 📋 23 - 47% open · ⏱️ 03.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipytree) (📥 5.9K / month):
	```
	pip install ipytree
	```
...
- [PyPi](https://pypi.org/project/ipysigma) (📥 160 / month):
	...
	```
- [NPM](https://www.npmjs.com/package/ipysigma) (📥 71 / month):
	```
...
- [GitHub](https://github.com/jtpio/ipyp5) (👨‍💻 2 · 🔀 4 · ⏱️ 16.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/ipyp5) (📥 53 / month):
	```
	pip install ipyp5
	```
</details>
...
- <b><a href="https://github.com/nipy/niwidgets">niwidgets</a></b> (🥉16 ·  ⭐ 64 · 💀) - Neuroimaging widgets for jupyter notebooks. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- [GitHub](https://github.com/jupyter-server/jupyter-resource-usage) (👨‍💻 14 · 🔀 53 · 📦 26 · 📋 49 - 51% open · ⏱️ 22.03.2021):
...
- [GitHub](https://github.com/jupyterhub/nbgitpuller) (👨‍💻 20 · 🔀 47 · 📦 300 · 📋 86 - 34% open · ⏱️ 21.03.2021):
...
- [GitHub](https://github.com/mamba-org/gator) (👨‍💻 24 · 🔀 16 · 📥 1 · 📦 1 · 📋 45 - 26% open · ⏱️ 20.04.2021):
...
- <b><a href="https://github.com/data-8/nbzip">nbzip</a></b> (🥉14 ·  ⭐ 67 · 💀) - Zips and downloads all the contents of a jupyter notebook. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- [GitHub](https://github.com/tmthyjames/SQLCell) (👨‍💻 14 · 🔀 9 · 📦 1 · 📋 84 - 71% open · ⏱️ 06.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/sqlcell) (📥 67 / month):
	```
	pip install sqlcell
	```
</details>
...
- <b><a href="https://github.com/csurfer/blackcellmagic">blackcellmagic</a></b> (🥈15 ·  ⭐ 260 · 💀) - IPython magic command to format python code in cell using.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/WolframResearch/WolframLanguageForJupyter) (👨‍💻 6 · 🔀 68 · 📥 3.5K · 📋 75 - 18% open · ⏱️ 15.12.2020):
...
- <b><a href="https://github.com/jupyter/kernel_gateway">Kernel Gateway</a></b> (🥈18 ·  ⭐ 340) - Jupyter Kernel Gateway. <code>❗Unlicensed</code>
...
- <b><a href="https://github.com/lfortran/lfortran">LFortran</a></b> (🥉15 ·  ⭐ 230) - Official mirror of https://gitlab.com/lfortran/lfortran. Please.. <code>❗Unlicensed</code>
...
- [GitHub](https://github.com/mwouts/jupytext) (👨‍💻 58 · 🔀 280 · 📦 1.4K · 📋 420 - 14% open · ⏱️ 25.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupytext) (📥 87K / month):
	```
...
- [GitHub](https://github.com/nteract/commuter) (👨‍💻 27 · 🔀 59 · 📦 3 · 📋 85 - 55% open · ⏱️ 19.04.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@nteract/commuter) (📥 480 / month):
	```
...
- [GitHub](https://github.com/SamLau95/nbinteract) (👨‍💻 8 · 🔀 22 · 📦 1 · 📋 68 - 39% open · ⏱️ 15.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/nbinteract) (📥 6.8K / month):
	```
	pip install nbinteract
	```
</details>
<details><summary><b><a href="https://github.com/danielfrg/mkdocs-jupyter">mkdocs-jupyter</a></b> (🥉16 ·  ⭐ 46) - Use Jupyter Notebook in mkdocs. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- <b><a href="https://github.com/ideonate/cdsdashboards">cdsdashboards</a></b> (🥉13 ·  ⭐ 92) - JupyterHub extension for ContainDS Dashboards. <code>❗Unlicensed</code>
</details>
<br>
...
- [GitHub](https://github.com/nbQA-dev/nbQA) (👨‍💻 12 · 🔀 12 · 📋 200 - 12% open · ⏱️ 19.04.2021):
...
- [GitHub](https://github.com/krassowski/jupyter-helpers) (👨‍💻 2 · 🔀 3 · 📋 5 - 60% open · ⏱️ 10.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyter_helpers) (📥 560 / month):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab-dash) (📥 1.6K / month):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-dash) (📥 200K / month):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab_theme_solarized_dark) (📥 420 / month):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-theme-solarized-dark) (📥 5.6K / month):
	```
...
<details><summary><b><a href="https://github.com/yeebc/jupyterlab-neon-theme">Neon Theme</a></b> (🥈13 ·  ⭐ 87) - A flat, 80's neon inspired theme for JupyterLab. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- <b><a href="https://github.com/jtpio/jupyterlab-theme-toggle">Theme Toggle</a></b> (🥉9 ·  ⭐ 8) - JupyterLab extension to toggle the theme in the Top Bar area. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- [GitHub](https://github.com/jupyterlab/debugger) (👨‍💻 11 · 🔀 34 · 📦 50 · 📋 260 - 6% open · ⏱️ 31.03.2021):
...
- [GitHub](https://github.com/finos/perspective) (👨‍💻 62 · 🔀 350 · 📦 180 · 📋 390 - 15% open · ⏱️ 22.04.2021):
...
- [GitHub](https://github.com/krassowski/jupyterlab-lsp) (👨‍💻 28 · 🔀 59 · 📦 1 · 📋 300 - 33% open · ⏱️ 19.04.2021):
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-toc) (👨‍💻 12 · 🔀 94 · 📦 63 · 📋 110 - 57% open · ⏱️ 20.11.2020):
...
<details><summary><b><a href="https://github.com/elyra-ai/elyra">elyra</a></b> (🥈20 ·  ⭐ 900) - Elyra extends JupyterLab Notebooks with an AI centric approach. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/elyra-ai/elyra) (👨‍💻 22 · 🔀 130 · 📦 18 · 📋 900 - 19% open · ⏱️ 20.04.2021):
...
- [GitHub](https://github.com/jtpio/jupyterlab-system-monitor) (👨‍💻 5 · 🔀 19 · 📦 4 · 📋 27 - 40% open · ⏱️ 20.04.2021):
...
- [GitHub](https://github.com/bokeh/jupyter_bokeh) (👨‍💻 14 · 🔀 27 · 📋 73 - 8% open · ⏱️ 03.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-bokeh) (📥 8.3K / month):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab_iframe) (📥 710 / month):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_iframe) (📥 2.1K / month):
	```
...
- [GitHub](https://github.com/parente/jupyterlab-quickopen) (👨‍💻 5 · 🔀 7 · ⏱️ 21.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-quickopen) (📥 610 / month):
	```
	pip install jupyterlab-quickopen
	```
- [NPM](https://www.npmjs.com/package/@parente/jupyterlab-quickopen) (📥 610 / month):
	```
...
- [Conda](https://anaconda.org/conda-forge/jupyterlab-sos) (📥 7.9K · ⏱️ 16.04.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-sos) (📥 590 / month):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab_hdf) (📥 780 / month):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/hdf5) (📥 800 / month):
	```
...
- [GitHub](https://github.com/itsjafer/jupyterlab-sparkmonitor) (👨‍💻 6 · 🔀 12 · 📋 11 - 72% open · ⏱️ 02.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-sparkmonitor) (📥 260 / month):
	```
...
- [GitHub](https://github.com/jtpio/ipylab) (👨‍💻 2 · 🔀 2 · 📋 23 - 43% open · ⏱️ 15.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipylab) (📥 360 / month):
	```
	pip install ipylab
	```
...
- [GitHub](https://github.com/timkpaine/jupyterlab_email) (🔀 2 · 📋 35 - 14% open · ⏱️ 31.01.2021):
	...
	git clone https://github.com/timkpaine/jupyterlab_email
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-flake8) (📥 870 / month):
	```
...
- [PyPi](https://pypi.org/project/knowledgelab) (📥 17 / month):
	...
	```
- [NPM](https://www.npmjs.com/package/knowledgelab) (📥 57 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/batchspawner) (👨‍💻 38 · 🔀 87 · 📦 8 · 📋 110 - 36% open · ⏱️ 07.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/batchspawner) (📥 700 / month):
	```
...
- <b><a href="https://github.com/uktrade/fargatespawner">FargateSpawner</a></b> (🥉11 ·  ⭐ 22 · 💤) - Spawns JupyterHub single user servers in Docker containers.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
<details><summary><b><a href="https://github.com/jupyter/jupyter-packaging">jupyter-packaging</a></b> (🥉21 ·  ⭐ 26) - Tools to help build and install Jupyter Python packages. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jupyter/jupyter-packaging) (👨‍💻 17 · 🔀 32 · 📋 20 - 25% open · ⏱️ 19.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-packaging) (📥 560K / month):
	```
...
- [GitHub](https://github.com/jupyter/qtconsole) (👨‍💻 110 · 🔀 150 · 📦 75K · 📋 270 - 32% open · ⏱️ 20.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/qtconsole) (📥 6.8M / month):
	```
...
- [GitHub](https://github.com/holoviz/panel) (👨‍💻 65 · 🔀 150 · 📦 1.3K · 📋 1.1K - 31% open · ⏱️ 20.04.2021):

	```
	git clone https://github.com/holoviz/panel
	```
- [PyPi](https://pypi.org/project/panel) (📥 100K / month):
	```
	pip install panel
	```
...
- [GitHub](https://github.com/abhi1thakur/colabcode) (👨‍💻 8 · 🔀 160 · 📦 22 · 📋 44 - 50% open · ⏱️ 03.02.2021):

	```
	git clone https://github.com/abhishekkrthakur/colabcode
	```
- [PyPi](https://pypi.org/project/colabcode) (📥 6.8K / month):
	```
